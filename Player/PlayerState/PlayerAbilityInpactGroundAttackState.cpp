...
void PlayerAbilityInpactGroundAttackState::Enter() {
	m_Owner->ChangeMotion(MotionAbilityInpactAttack, false);
...
void PlayerAbilityInpactGroundAttackState::Execute(float delta_time) {
...
void PlayerAbilityInpactGroundAttackState::Exit() {
	m_Owner->ResetVelocity();
	m_Owner->SetNextAttackStateFrag(false);

}

void PlayerAbilityInpactGroundAttackState::OnMessage(const std::string& message, void* param) {}